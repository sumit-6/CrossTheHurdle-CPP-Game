...
class CrossTheHurdle
{
	Mat img;
	queue<vector<int>> newPoints;
	vector<vector<int>> myColors = {
									{70, 178, 88, 179, 255, 204}
								   };
...
public:
	...
	void Game()
	{
		...
		while (true)
		{
			...
			{
				putText(img, "You've Lost", Point(230, 262), FONT_HERSHEY_DUPLEX, 1.05, Scalar(255, 255, 255), 2);
				putText(img, "Press \"Enter\" key to replay", Point(160, 290), FONT_HERSHEY_DUPLEX, 0.8, Scalar(255, 255, 255), 2);
				putText(img, "Press any other key to leave", Point(160, 320), FONT_HERSHEY_DUPLEX, 0.8, Scalar(255, 255, 255), 2);
